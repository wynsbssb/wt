...
local settingsTable = {
	General = {
		...
		rayfieldOpen = {Type = 'bind', Value = 'K', Name = '快捷键'},
...
local function loadSettings()
	...
	local success, result =	pcall(function()
		task.spawn(function()
			...
			if useStudio then
				file = [[
		{"General":{"rayfieldOpen":{"Value":"K","Type":"bind","Name":"界面快捷键","Element":{"HoldToInteract":false,"Ext":true,"Name":"界面快捷键","Set":null,"CallOnChange":true,"Callback":null,"CurrentKeybind":"K"}}},"System":{"usageAnalytics":{"Value":false,"Type":"toggle","Name":"匿名分析","Element":{"Ext":true,"Name":"匿名分析","Set":null,"CurrentValue":false,"Callback":null}}}}
	]]
			end
...
local function Hide(notify: boolean?)
    ...
    if useMobilePrompt then 
        RayfieldLibrary:Notify({Title = "界面已隐藏", Content = "界面已隐藏，轻点「显示Rayfield」可恢复界面。", Duration = 7, Image = 4400697855})
    else
        RayfieldLibrary:Notify({Title = "界面已隐藏", Content = "界面已隐藏，按下 "..(settingsTable.General.rayfieldOpen.Value or 'K').." 键可恢复界面。", Duration = 7, Image = 4400697855})
    end
end
...
function RayfieldLibrary:CreateWindow(Settings)
	...
	if Settings.LoadingTitle ~= "Rayfield Interface Suite" then
		LoadingFrame.Version.Text = "SN.com"
	end
